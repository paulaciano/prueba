...
public class Ejercicio4 {
	...
	private static void informacion(List<Integer> lista1, Integer numero) {
		...
		System.out.println("Cantidad de números pares en la lista: " + pares);
		
		System.out.println("Números impares de la lista: " + impares.toString());
		
		int p = lista1.size() / 2;
		
		System.out.println("Número del medio de la primer lista: " + lista1.indexOf(p));
		
		if (c > lista1.size() / 2) {
			System.out.println("Más de la mitad de los números de la primer lista son mayores que " + numero + ".");
		} else if (c > 0) {
			System.out.println("Menos de la mitad de los números de la primer lista son mayores que " + numero + ".");
		} else {
			System.out.println("No hay números mayores que " + numero + "en la primer lista.");
		}
	}
